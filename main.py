...
# ---------------stock selection------------------
STOCKS = np.array([ "GOOG", "GME", "FB","AAPL",'TSLA','MSN','AMZN','BTC-USD','ETH-USD','SBIN','HDFC','TCS','DOGE-USD','GTLB','RACE','PFE'])  #many possible stocks
SYMB = window_selection_c.selectbox("select stock", STOCKS)


chart_width= st.expander(label="chart width").slider("", 500, 1000, 750, key='CHART_WIDTH')
